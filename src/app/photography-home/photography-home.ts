...
import { BlogsHomepage } from '../blogs/blogs-homepage/blogs-homepage';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, RouterModule, HttpClientModule, HomeNumbers, CountriesVisited, BlogsHomepage]
})
